...
const steps = [
  {
    ...
    desc: "Export your electricity and/or water consumption records from your current metering system or billing provider. WattWise accepts standard CSV and Excel formats. Upload the file through the operator dashboard and the system validates, maps, and ingests the records automatically — flagging any rows that need attention.",
    details: [
      "Accepted formats: CSV, Excel (.xlsx)",
      "Minimum recommended history: 12 months",
      "Downloadable sample template available",
      "Validation report shown on upload",
      "Partial imports handled with issue log",
    ],
    note: "No specialist IT skills needed. If you can export a spreadsheet, you can upload to WattWise.",
  },
  {
    num: "02",
    icon: Target,
